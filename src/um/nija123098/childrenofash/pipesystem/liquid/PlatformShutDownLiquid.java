 ...
 */
public class PlatformShutDownLiquid extends Liquid {
    private static final long serialVersionUID = Reference.serialVersionUID;
    // @Deprecated protected PlatformShutDownLiquid(){}
    public PlatformShutDownLiquid(){
        System.out.println("PSDLiq issued");
    }
}
